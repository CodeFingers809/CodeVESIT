<x-app-layout>
    ...
    <div class="mb-6 flex flex-wrap gap-2">
        ...
        <a href="{{ route('calendar.index') }}" class="px-4 py-2 rounded-lg font-medium transition-colors bg-gruvbox-light-bg1 dark:bg-gruvbox-dark-bg1 text-gruvbox-light-fg0 dark:text-gruvbox-dark-fg0 hover:bg-gruvbox-light-bg2 dark:hover:bg-gruvbox-dark-bg2">
            Personal Calendar
        </a>
    </div>
